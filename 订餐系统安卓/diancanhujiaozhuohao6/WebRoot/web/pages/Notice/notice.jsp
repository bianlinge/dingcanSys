    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '总额', width: 100, field: 'title', sortable: true},
                {title: '采购物品说明', width: 400, field: 'note',sortable: true},
...
<div id="managerDialog" class="easyui-dialog" title="采购管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                <th width="30%" align="right"><label>总额：</label></th>
            ...
            <tr>
                <th width="30%" align="right"><label>采购物品说明：</label></th>
