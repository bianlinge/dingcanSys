...
function deleteItem(uuid) {
    openBackGround();
    $.post("<%=__APP__%>/Fuwu!deleteItem", {id: uuid}, function (data) {
        closeBackGround();
        closeFlush();
    });
}
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                ...
                <td width="60%" colspan="1">
                    <input id="title" name="fuwu.title" class="easyui-validatebox"
            ...
            <tr>
                ...
                <td width="60%" colspan="1">
                    <select id="state" name="fuwu.state">
            ...
            <tr>
                ...
                <td colspan="1" width="60%">
                    <textarea style="width:300px;height: 100px;" id="note" name="fuwu.note"></textarea>
                </td>
            </tr>
        </table>
